...
|:---|:---|:---|:---|
| **macOS** | Apple Silicon & Intel Universal | `.dmg` Installer | [Download Tailride for macOS (`.dmg`)](https://github.com/Tailride/desktop-releases/releases/download/v0.5.0/Tailride-0.5.0-universal.dmg) |
| **macOS** | Apple Silicon & Intel Universal | `.zip` (Auto-update archive) | [Download Tailride macOS Archive (`.zip`)](https://github.com/Tailride/desktop-releases/releases/download/v0.5.0/Tailride-0.5.0-universal.zip) |
| **Windows** | 64-bit (x64) | Setup Installer (`.exe`) | [Download Tailride for Windows (`.exe`)](https://github.com/Tailride/desktop-releases/releases/download/v0.5.0/Tailride-Setup-0.5.0.exe) |
| **Windows** | 64-bit (x64) | Portable (`.exe`) | [Download Tailride Portable (`.exe`)](https://github.com/Tailride/desktop-releases/releases/download/v0.5.0/Tailride-0.5.0-x64.exe) |
...
1. Download **[Tailride-0.5.0-universal.dmg](https://github.com/Tailride/desktop-releases/releases/download/v0.5.0/Tailride-0.5.0-universal.dmg)**.
...
1. Download **[Tailride-Setup-0.5.0.exe](https://github.com/Tailride/desktop-releases/releases/download/v0.5.0/Tailride-Setup-0.5.0.exe)**.
